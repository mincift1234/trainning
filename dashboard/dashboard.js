...
function openTrainingPopup(type) {
    ...
    db.collection("users")
        ...
        .then((doc) => {
            if (doc.exists) {
                const data = doc.data();
                document.getElementById("aimlab-title").value = data.title || "";
                document.getElementById("aimlab-time").value = data.time || "";
            } else {
                document.getElementById("aimlab-title").value = "";
...
document.getElementById("save-training").addEventListener("click", () => {
    const title = document.getElementById("aimlab-title").value;
